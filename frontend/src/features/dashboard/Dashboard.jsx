...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white p-0 relative overflow-hidden">
      {/* Minimal, professional background accents */}
      <div className="fixed top-0 right-0 w-[650px] h-[650px] bg-gradient-to-b from-[#4D55CC]/[0.03] to-transparent rounded-full transform translate-x-1/3 -translate-y-1/3"></div>
      <div className="fixed bottom-0 left-0 w-[800px] h-[800px] bg-gradient-to-t from-[#3E7B27]/[0.02] to-transparent rounded-full transform -translate-x-1/2 translate-y-1/2"></div>
